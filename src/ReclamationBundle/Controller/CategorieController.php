...
//affiche categorie service mobile
    public function afficheCategorieCNAction()
    {
        $modele=$this->getDoctrine()->getRepository(Categorie::class)->FindAll();
...
//ajout categorie service mobile
    public function ajoutCategorieCNAction($nomc,$des)
    {
        $modele=new Categorie();
            $em=$this->getDoctrine()->getManager();
$modele->setNomC($nomc);
...
// supprimer categorie service
    public function supprimerCategorieCNAction($id)
    {
