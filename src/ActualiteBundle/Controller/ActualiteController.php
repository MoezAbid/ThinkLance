...
class ActualiteController extends FOSController
{
    ...
    public function actuApiAction()
    {
        ...
        return new JsonResponse($arrayTech);
    }

    public function progApiAction()
    {
        $client = new Client();
        ...
        return new JsonResponse($arrayProg);
    }

    public function freeApiAction()
    {
        $client = new Client();
        ...
        return new JsonResponse($arrayFreelance);
    }
