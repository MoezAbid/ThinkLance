...
class PaiementRepository extends \Doctrine\ORM\EntityRepository
{
    ...
    public function findPaiement($idemp,$idfree)
    {
        $query = $this->getEntityManager()
            ->createQuery("SELECT f FROM PaiementBundle:Paiement f WHERE f.employeur=:idEmp AND f.freelancer=:idFree")->setParameter('idEmp', $idemp)->setParameter('idFree', $idfree);
